...
public class Pawn extends Piece {
	...
	void findMovables(Square[][] board, boolean bqc, boolean bkc, boolean wqc, boolean wkc) {
		if(this.color=='w'){
			...
			if(this.pos_x==1 && board[3][this.pos_y]==null && board[2][this.pos_y]==null) Moveable[3][this.pos_y]=true; //처음 움직이는 폰은 두 칸 움직일 수 있다
		}
		else{
			for(int i=0; i<8; i++){
				for(int j=0; j<8; j++){
				...
				if(this.pos_x==6 && board[4][this.pos_y]==null && board[5][this.pos_y]==null) Moveable[4][this.pos_y]=true;
			}
		}
	}
}
